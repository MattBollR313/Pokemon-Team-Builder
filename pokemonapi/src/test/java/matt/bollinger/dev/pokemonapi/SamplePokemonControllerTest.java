...
public class SamplePokemonControllerTest {
	...
	public void testProperListResponse() throws Exception {
		List<String> correctPokemon = new ArrayList<String>();
		correctPokemon.add("Bulbasaur");
		correctPokemon.add("Ivysaur");
		correctPokemon.add("Venusaur");
		correctPokemon.add("Charmander");
		correctPokemon.add("Charmeleon");
		correctPokemon.add("Charizard");
